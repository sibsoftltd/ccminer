...
extern "C" void c12hash(void *output, const void *input)
{
...
extern "C" int scanhash_c12(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done)
{
...
// cleanup
extern "C" void free_c12(int thr_id)
{
	if (!init[thr_id])
		return;
