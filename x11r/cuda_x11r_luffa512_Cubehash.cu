...
#endif
void x11r_luffaCubehash512_gpu_hash_64(uint32_t threads, uint32_t *g_hash)
{
...
__host__
void x11r_luffaCubehash512_cpu_hash_64(int thr_id, uint32_t threads, uint32_t *d_hash, int order)
{
	...
	x11r_luffaCubehash512_gpu_hash_64 <<<grid, block>>> (threads, d_hash);
	MyStreamSynchronize(NULL, order, thr_id);
}

// Setup
__host__
void x11r_luffaCubehash512_cpu_init(int thr_id, uint32_t threads) {}
